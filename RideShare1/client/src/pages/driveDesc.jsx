...
import Booking from "./bookingPG";



export default function DriveDesc() {
 ...
 return (
    ...
    <div className="mainfont">
        ...
        <a className="underline link" target="_blank" href={'https://maps.google.com/?q='+drive.Sloc}>{drive.Sloc}</a>
        <h1>End Place: {drive.ECity}</h1>
        <a className="underline link" target="_blank" href={'https://maps.google.com/?q='+drive.Eloc}>{drive.Eloc}</a>
        ...
        <Booking Pdrive={drive} user={user}/>
    </div>
      </ReactModal>
    </div>
  );
